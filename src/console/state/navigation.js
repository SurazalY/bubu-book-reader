export const SCHOOL_NAV_ITEMS = [
  ...
  { key: 'accounts', label: '账号管理', icon: 'UserRound', groups: [{ key: 'accounts.live', label: '班级与成员', icon: 'Users', items: [{ key: 'accounts.students', label: '学生目录', path: '/console/accounts/students' }, { key: 'accounts.classes', label: '班级', path: '/console/accounts/classes' }, { key: 'accounts.credentials', label: '凭据与重置', path: '/console/accounts/org' }] }] },
