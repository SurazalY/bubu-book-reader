...
export default function AiPanel({ open, onClose, book, bookId, currentPageNo, readRangeVersion, blocker, safeMode, onJumpPage, onConfirmedInteraction, classroom }) {
  ...
  const submit = async () => {
    ...
    onConfirmedInteraction?.(aiQuotes)
    setDraft('')
    clearAiQuotes()
  }
